...
def test_add_attribute_valid_data(db: Session, add_attribute_valid_data: Dict[str, Any]) -> None:
...
def test_add_attribute_invalid_event_id(
    invalid_or_non_existing_ids: str, add_attribute_valid_data: Dict[str, Any]
) -> None:
    headers = {"authorization": environment.site_admin_user_token}
...
def test_add_attribute_response_format(existing_id: str, add_attribute_valid_data: Dict[str, Any]) -> None:
    headers = {"authorization": environment.site_admin_user_token}
    response = client.post(f"/attributes/{existing_id}", json=add_attribute_valid_data, headers=headers)
    assert response.headers["Content-Type"] == "application/json"


def test_add_attribute_authorization(existing_id: str, add_attribute_valid_data: Dict[str, Any]) -> None:
