...
async def test_get_workers_success(site_admin_user_token, client) -> None:
    ...
    # tests
    response = await client.get("/worker/all", headers={"authorization": site_admin_user_token})
...
async def test_get_jobs_workers_success(site_admin_user_token, client) -> None:
    ...
    response = await client.get("/worker/jobs/abc", headers={"authorization": site_admin_user_token})
...
async def test_pause_worker_success(site_admin_user_token, client) -> None:
    ...
    response = await client.post("/worker/pause/abc", headers={"authorization": site_admin_user_token})
...
async def test_unpause_worker_success(site_admin_user_token, client) -> None:
    ...
    response = await client.post("/worker/unpause/abc", headers={"authorization": site_admin_user_token})
...
async def test_list_all_queues_worker_success(site_admin_user_token, client) -> None:
    ...
    response = await client.get("/worker/jobqueue/abc", headers={"authorization": site_admin_user_token})
...
async def test_returning_jobs_success(site_admin_user_token, client) -> None:
    ...
    response = await client.get("/worker/returningJobs/", headers={"authorization": site_admin_user_token})
