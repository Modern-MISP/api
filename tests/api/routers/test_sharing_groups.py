...
def test_create_valid_sharing_group_with_org_id_overwrite(
    db: Session, instance_two_owner_org, site_admin_user_token
) -> None:
    body = {
...
def test_create_sharing_group_with_org_id_overwrite_but_not_enough_permissions(
    instance_two_owner_org, instance_owner_org_admin_user_token, instance_owner_org
) -> None:
    body = {
        "name": f"Test Sharing Group {uuid()}{time_ns()}",
        "description": "description",
...
def test_get_own_created_sharing_group(db: Session, instance_owner_org, instance_owner_org_admin_user_token) -> None:
...
def test_get_sharing_group_with_access_through_sharing_group_org(
    db: Session, instance_owner_org, instance_org_two, instance_org_two_admin_user_token
) -> None:
    sharing_group = generate_sharing_group()
    sharing_group.organisation_uuid = instance_owner_org.uuid
    sharing_group.org_id = instance_owner_org.id
...
def test_get_sharing_group_with_access_through_sharing_group_server(
    db: Session, instance_owner_org, instance_org_two_admin_user_token
) -> None:
    sharing_group = generate_sharing_group()
    sharing_group.organisation_uuid = instance_owner_org.uuid
    sharing_group.org_id = instance_owner_org.id
...
def test_get_sharing_group_with_access_through_site_admin(db: Session, instance_org_two, site_admin_user_token) -> None:
    sharing_group = generate_sharing_group()
...
def test_get_sharing_group_with_no_access(
    db: Session, instance_org_two, instance_two_owner_org_admin_user_token
) -> None:
    sharing_group = generate_sharing_group()
    sharing_group.organisation_uuid = instance_org_two.uuid
    sharing_group.org_id = instance_org_two.id
    ...
    response = client.get(
        f"/sharing_groups/{sharing_group.id}",
        headers={"authorization": instance_two_owner_org_admin_user_token},
    )

    assert response.status_code == status.HTTP_404_NOT_FOUND


def test_update_own_sharing_group(db: Session, instance_org_two, instance_org_two_admin_user_token) -> None:
    sharing_group = generate_sharing_group()
    sharing_group.organisation_uuid = instance_org_two.uuid
    sharing_group.org_id = instance_org_two.id
...
def test_update_sharing_group_with_access_through_site_admin(
    db: Session, instance_org_two, site_admin_user_token
) -> None:
    sharing_group = generate_sharing_group()
    sharing_group.organisation_uuid = instance_org_two.uuid
    sharing_group.org_id = instance_org_two.id
...
def test_update_sharing_group_no_access_although_sharing_group_org_exists(
    db: Session, instance_owner_org, instance_org_two, site_admin_user_token, instance_owner_org_admin_user_token
) -> None:
    sharing_group = generate_sharing_group()
    sharing_group.organisation_uuid = instance_org_two.uuid
    sharing_group.org_id = instance_org_two.id
...
def test_delete_sharing_group_no_access_although_sharing_group_org_exists(
    db: Session, instance_owner_org, instance_org_two, instance_owner_org_admin_user_token
) -> None:
    sharing_group = generate_sharing_group()
    sharing_group.organisation_uuid = instance_org_two.uuid
    sharing_group.org_id = instance_org_two.id
...
def test_list_own_sharing_group(db: Session, instance_owner_org, instance_owner_org_admin_user_token) -> None:
    sharing_group = generate_sharing_group()
    sharing_group.organisation_uuid = instance_owner_org.uuid
    sharing_group.org_id = instance_owner_org.id
...
def test_list_own_sharing_group_site_admin(db: Session, instance_owner_org, site_admin_user_token) -> None:
    sharing_group = generate_sharing_group()
    sharing_group.organisation_uuid = instance_owner_org.uuid
    sharing_group.org_id = instance_owner_org.id
...
def test_list_sharing_group_with_access_through_sharing_group_server(
    db: Session, instance_org_two, instance_owner_org_admin_user_token
) -> None:
    sharing_group = generate_sharing_group()
    sharing_group.organisation_uuid = instance_org_two.uuid
    sharing_group.org_id = instance_org_two.id
...
def test_get_own_created_sharing_group_info(
    db: Session, instance_owner_org, instance_owner_org_admin_user_token
) -> None:
    sharing_group = generate_sharing_group()
    sharing_group.organisation_uuid = instance_owner_org.uuid
    sharing_group.org_id = instance_owner_org.id
...
def test_get_sharing_group_info_with_access_through_site_admin(
    db: Session, site_admin_user_token, sharing_group
) -> None:
    response = client.get(
        f"/sharing_groups/{sharing_group.id}/info",
        headers={"authorization": site_admin_user_token},
...
def test_add_org_to_own_sharing_group(db: Session, instance_owner_org, instance_owner_org_admin_user_token) -> None:
    sharing_group = generate_sharing_group()
    sharing_group.organisation_uuid = instance_owner_org.uuid
    sharing_group.org_id = instance_owner_org.id
...
def test_patch_org_to_own_sharing_group(
    db: Session, instance_owner_org, instance_owner_org_admin_user_token, sharing_group
) -> None:
...
def test_add_org_to_sharing_group_using_site_admin(
    db: Session, instance_org_two, site_admin_user_token, sharing_group
) -> None:
    response = client.patch(
        f"/sharing_groups/{sharing_group.id}/organisations",
        headers={"authorization": site_admin_user_token},
...
def test_add_org_to_sharing_group_with_no_access(
    db: Session, sharing_group, instance_owner_org, instance_owner_org_admin_user_token
) -> None:
    sharing_group_org = SharingGroupOrg(sharing_group_id=sharing_group.id, org_id=instance_owner_org.id)
...
def test_remove_org_from_own_sharing_group(db: Session, sharing_group, instance_owner_org_admin_user_token) -> None:
...
def test_patch_server_to_own_sharing_group(db, sharing_group, instance_owner_org_admin_user_token) -> None:
...
def test_remove_server_from_own_sharing_group(db: Session, sharing_group, instance_owner_org_admin_user_token) -> None:
...
def test_create_valid_sharing_group_legacy(instance_owner_org, site_admin_user_token) -> None:
    body = {"name": f"Test Sharing Group {uuid()}{time_ns()}", "description": "description", "releasability": "yes"}
...
def test_get_sharing_group_legacy_with_access_through_sharing_group_org(
    db: Session, sharing_group, instance_org_two, instance_org_two_admin_user_token
) -> None:
    sharing_group_org = SharingGroupOrg(sharing_group_id=sharing_group.id, org_id=instance_org_two.id)
...
def test_get_sharing_group_legacy_with_access_through_sharing_group_server(
    db: Session, sharing_group, instance_org_two_admin_user_token
) -> None:
    sharing_group_server = SharingGroupServer(sharing_group_id=sharing_group.id, server_id=0, all_orgs=True)
...
def test_get_sharing_group_legacy_with_no_access(
    db: Session, sharing_group, instance_two_owner_org_admin_user_token
) -> None:
    sharing_group_server = SharingGroupServer(sharing_group_id=sharing_group.id, server_id=0, all_orgs=True)
...
def test_delete_own_sharing_group_legacy(
    db: Session, instance_owner_org, sharing_group, instance_org_two_admin_user_token
) -> None:
    sharing_group_id = sharing_group.id
...
def test_delete_sharing_group_legacy_with_access_through_site_admin(
    db: Session, sharing_group, instance_org_two, site_admin_user_token
) -> None:
    response = client.delete(
...
def test_add_org_to_own_sharing_group_legacy(db: Session, sharing_group, instance_owner_org_admin_user_token) -> None:
    response = client.post(
...
def test_patch_org_to_own_sharing_group_legacy(db: Session, sharing_group, instance_owner_org_admin_user_token) -> None:
...
def test_add_org_to_sharing_group_legacy_with_no_access(
    db: Session, instance_org_two, instance_owner_org_admin_user_token, sharing_group, instance_owner_org
) -> None:
    sharing_group_org = SharingGroupOrg(sharing_group_id=sharing_group.id, org_id=instance_owner_org.id)
...
def test_remove_org_from_own_sharing_group_legacy(
    db: Session, sharing_group, instance_owner_org_admin_user_token
) -> None:
    sharing_group_org = SharingGroupOrg(sharing_group_id=sharing_group.id, org_id=999)
...
def test_add_server_to_sharing_group_legeacy_using_site_admin(
    db: Session, sharing_group, site_admin_user_token
) -> None:
    response = client.post(
        f"/sharing_groups/addServer/{sharing_group.id}/999",
        headers={"authorization": site_admin_user_token},
