...
@respx.mock
def test_get_job(site_admin_user_token, client) -> None:
...
@respx.mock
def test_get_job_unfinished(site_admin_user_token, client) -> None:
...
@respx.mock
def test_get_job_no_result(site_admin_user_token, client) -> None:
...
@respx.mock
def test_get_job_unexpected_error(site_admin_user_token, client) -> None:
