...
async def test_list_all_events_self_created(access_test_objects, client) -> None:
    ...
    print("test_list_all_events_self_created default_event_published: ",
          access_test_objects["default_event_published"].can_access(user))
    print("test_list_all_events_self_created event_no_access: ",
          access_test_objects["event_no_access"].can_access(user))
    print("test_list_all_events_self_created event_read_only_user: ",
          access_test_objects["event_read_only_user"].can_access(user))
    print("test_list_all_events_self_created event_read_only_user_2: ",
          access_test_objects["event_read_only_user_2"].can_access(user))
    print("test_list_all_events_self_created event_dist_comm: ",
          access_test_objects["event_dist_comm"].can_access(user))
    print("test_list_all_events_self_created event_dist_comm_2: ",
    ...
    print("test_list_all_events_self_created event_dist_sg_2: ",
          access_test_objects["event_dist_sg_2"].can_access(user))
