...
async def test_list_all_events_read_only_user(
    event3, event4, event5, event_read_only_1, read_only_user_token, client
) -> None:
...
@pytest.mark.asyncio
async def test_get_event_success_read_only_user(event_read_only_1, read_only_user_token, client) -> None:
    headers = {"authorization": read_only_user_token}
...
@pytest.mark.asyncio
async def test_get_event(event, site_admin_user_token, client) -> None:
    headers = {"authorization": site_admin_user_token}
    event_id = event.id
    response = client.get(f"/events/{event_id}", headers=headers)
...
@pytest.mark.asyncio
async def test_get_event_fail_read_only_user(event, read_only_user_token, client) -> None:
    headers = {"authorization": read_only_user_token}
    event_id = event.id
    response = client.get(f"/events/{event_id}", headers=headers)
...
@pytest.mark.asyncio
async def test_valid_search_attribute_data_read_only_user(event_read_only_1, read_only_user_token, client) -> None:
...
@pytest.mark.asyncio
async def test_publish_existing_event_read_only_user(event_read_only_1, read_only_user_token, client) -> None:
    event_id = event_read_only_1.id
    headers = {"authorization": read_only_user_token}
...
@pytest.mark.asyncio
async def test_publish_existing_event_fail_read_only_user(event, read_only_user_token, client) -> None:
    event_id = event.id
    headers = {"authorization": read_only_user_token}
    response = client.post(f"/events/publish/{event_id}", headers=headers)
    response_json = response.json()
...
@pytest.mark.asyncio
async def test_add_existing_tag_to_event_read_only_user(event_read_only_1, tag, read_only_user_token, client) -> None:
    tag_id = tag.id
    event_id = event_read_only_1.id
...
async def test_remove_existing_tag_from_event_read_only_user(
    event_read_only_1, tag, eventtag, read_only_user_token, client
) -> None:
    tag_id = tag.id
    event_id = event_read_only_1.id
...
async def test_remove_existing_tag_from_event_fail_read_only_user(
    event, tag, eventtag, read_only_user_token, client
) -> None:
    tag_id = tag.id
    event_id = event.id
...
@pytest.mark.asyncio
async def test_edit_existing_event_read_only_user(event_read_only_1, read_only_user_token, client) -> None:
...
@pytest.mark.asyncio
async def test_delete_existing_event_read_only_user(event_read_only_1, read_only_user_token, client) -> None:
    event_id = event_read_only_1.id
...
@pytest.mark.asyncio
async def test_delete_existing_event_fail_read_only_user(event, read_only_user_token, client) -> None:
    event_id = event.id
...
# @pytest.mark.asyncio
# async def test_valid_freetext_import_readonly_user(organisation, event_read_only_1, attribute, read_only_user_token, client) -> None:
