...
from app.schemas.authentication.start_login_body import StartLoginBody
from app.schemas.authentication.start_login_response import StartLoginResponse
from app.schemas.authentication.password_login_body import PasswordLoginBody
from app.schemas.authentication.token_response import TokenResponse
from app.schemas.authentication.exchange_token_login_body import ExchangeTokenLoginBody
...
async def redirect_to_frontend(identityProviderId: str) -> RedirectResponse:
    return RedirectResponse(
        url="frontend_url?exchangeToken=generated_token", status_code=302
    )
