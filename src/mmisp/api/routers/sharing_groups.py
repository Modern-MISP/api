...
from mmisp.api_schemas.sharing_groups.create_update_sharing_group_body import CreateUpdateSharingGroupBody
...
async def create_sharing_group(
    auth: Annotated[Auth, Depends(authorize(AuthStrategy.ALL, [Permission.ADD, Permission.SHARING_GROUP]))],
...
async def update_sharing_group(
    auth: Annotated[Auth, Depends(authorize(AuthStrategy.ALL, [Permission.MODIFY, Permission.SHARING_GROUP]))],
    db: Annotated[Session, Depends(get_db)],
    id: str,
    body: CreateUpdateSharingGroupBody,
) -> SharingGroup:
...
async def add_org_to_sharing_group(id: str, body: AddOrgToSharingGroupBody) -> SharingGroupOrg:
    return SharingGroupOrg()


@router.delete("/sharing_groups/{id}/organizations/{organisationId}")
async def remove_org_from_sharing_group(id: str, organisationId: str) -> SharingGroupOrg:
    return SharingGroupOrg()


@router.patch("/sharing_groups/{id}/servers")
async def add_server_to_sharing_group(id: str, body: AddServerToSharingGroupBody) -> SharingGroupServer:
    return SharingGroupServer()


@router.delete("/sharing_groups/{id}/servers/{serverId}")
async def remove_server_from_sharing_group(id: str, serverId: str) -> SharingGroupServer:
    return SharingGroupServer()
...
async def create_sharing_group_legacy(body: CreateSharingGroupLegacyBody) -> CreateSharingGroupLegacyResponse:
    return CreateSharingGroupLegacyResponse()


@router.get("/sharing_groups/view/{sharingGroupId}", deprecated=True)
async def view_sharing_group_legacy(sharingGroupId: str) -> ViewSharingGroupLegacyResponse:
    return ViewSharingGroupLegacyResponse()


@router.post("/sharing_groups/edit/{sharingGroupId}", deprecated=True)
async def update_sharing_group_legacy(sharingGroupId: str, body: UpdateSharingGroupLegacyBody) -> SharingGroup:
    return SharingGroup()


@router.delete("/sharing_groups/delete/{sharingGroupId}", deprecated=True)
async def delete_sharing_group_legacy(sharingGroupId: str) -> DeleteSharingGroupLegacyResponse:
    return DeleteSharingGroupLegacyResponse()


@router.post("/sharing_groups/addOrg/{sharingGroupId}/{organisationId}", deprecated=True)
async def add_org_to_sharing_group_legacy(
    sharingGroupId: str, organisationId: str, body: AddOrgToSharingGroupLegacyBody
) -> StandardStatusResponse:
    return StandardStatusResponse()


@router.post("/sharing_groups/removeOrg/{sharingGroupId}/{organisationId}", deprecated=True)
async def remove_org_from_sharing_group_legacy(sharingGroupId: str, organisationId: str) -> StandardStatusResponse:
    return StandardStatusResponse()


@router.post("/sharing_groups/addServer/{sharingGroupId}/{serverId}", deprecated=True)
async def add_server_to_sharing_group_legacy(
    sharingGroupId: str, serverId: str, body: AddServerToSharingGroupLegacyBody
) -> StandardStatusResponse:
    return StandardStatusResponse()


@router.post("/sharing_groups/removeServer/{sharingGroupId}/{serverId}", deprecated=True)
async def remove_server_from_sharing_group_legacy(sharingGroupId: str, serverId: str) -> StandardStatusResponse:
    return StandardStatusResponse()
